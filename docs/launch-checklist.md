...
The project needs three things before a serious launch:

1. A short demo people can understand in under 30 seconds.
2. A zero-friction install path such as `npx codex-brain quickstart`.
...
- Make `npx codex-brain quickstart` the primary install story.
